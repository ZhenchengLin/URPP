    ...
    def generate_structured(
        ...
        *,
        ...
        contextual_instructions = (
            ...
            + "CURRENT QUESTION PRIORITY: Answer the student's "
              "current_student_message directly. Use history "
              "only for continuity, not to restart a prior "
              "lesson. Answer the question first, then give "
              "only the background needed. Do not repeat "
              "earlier explanations unless requested.\\n"
            + "COURSE GROUNDING: Use permitted excerpts for "
              "course-specific claims. If those excerpts do "
              "not answer the current question, explicitly "
              "say the uploaded material does not establish "
              "an answer. Do not substitute an explanation "
              "of an unrelated previous topic or attribute "
              "outside knowledge to any course source. "
              "This course-only contract does not authorize "
              "an independent general-knowledge answer.\\n"
            + "TRUST BOUNDARY: The selected teaching_action, "
